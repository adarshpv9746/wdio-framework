...
const DashPage = require('../../pageobjects/dash.page.js')
const helper = require('../../helpers/helper.js')
const regPage = require('../../pageobjects/reg.page.js')
...
describe('Registration Test Cases: ', () => {
    ...
    it('Should register a new user without gender', async () => {
        ...
        await regPage.regusr("",helper.test_uname, helper.test_string, "1","January","2020",helper.random_mail("etester","mailinator.com"),helper.test_uname,"password","password")
    ...
    it('Should not register a new user without first name', async () => {
        ...
        //await DashPage.register();
        await regPage.open()
        await regPage.regusr("f",'', helper.test_string, "1","January","2020",helper.random_mail("etester","mailinator.com"),helper.test_uname,"password","password")
    ...
    it('Should not register a new user without last name', async () => {
        ...
        //register (gender, fname, lname, day, month, year, email, company, password, cpassword)
        //await DashPage.register();
        await regPage.regusr("m",helper.test_uname,'', "1","January","2020",helper.random_mail("etester","mailinator.com"),helper.test_uname,"password","password")
    ...
    it('Should register a new user without day', async () => {
        ...
        //register (gender, fname, lname, day, month, year, email, company, password, cpassword)
        //await DashPage.register();
        await regPage.regusr("m",helper.test_uname, helper.test_string, "Day","January","2020",helper.random_mail("etester","mailinator.com"),helper.test_uname,"password","password")
        await expect(SecurePage.regsuccess).toBeExisting()
        await expect(SecurePage.regsuccess).toHaveTextContaining('Your registration completed')
    ...
    it('Should register a new user without month', async () => {
        ...
        //await DashPage.register();
        await regPage.open();
        await regPage.regusr("m",helper.test_uname, helper.test_string, "1",'Month',"2020",helper.random_mail("etester","mailinator.com"),helper.test_uname,"password","password")
        await expect(SecurePage.regsuccess).toBeExisting()
        await expect(SecurePage.regsuccess).toHaveTextContaining('Your registration completed')
    ...
    it('Should register a new user without company name', async () => {
        ...
        //register (gender, fname, lname, day, month, year, email, company, password, cpassword)
        //await DashPage.register();
        await regPage.regusr("m",helper.test_uname, helper.test_string, "1","January","2020",helper.random_mail("etester","mailinator.com"),'',"password","password")
        await expect(SecurePage.regsuccess).toBeExisting()
        await expect(SecurePage.regsuccess).toHaveTextContaining('Your registration completed')
    ...
    it('Should not register a new user without password', async () => {
        ...
        //await DashPage.register();
        await regPage.open()
        await regPage.regusr("m",helper.test_uname, helper.test_string, "1","January","2020",helper.random_mail("etester","mailinator.com"),helper.test_uname,'','')
    ...
    it('Should not register a new user without matching confirmation password', async () => {
        ...
        //register (gender, fname, lname, day, month, year, email, company, password, cpassword)
        //await DashPage.register();
        await regPage.regusr("m",helper.test_uname, helper.test_string, "1","January","2020",helper.random_mail("etester","mailinator.com"),helper.test_uname,'password','aaaaaa')
    ...
    it('Should not register a new user without confirmation password', async () => {
        ...
        //register (gender, fname, lname, day, month, year, email, company, password, cpassword)
        //await DashPage.register();
        await regPage.regusr("m",helper.test_uname, helper.test_string, "1","January","2020",helper.random_mail("etester","mailinator.com"),helper.test_uname,'password','')
    ...
    it('Should not register a new user without a valid password', async () => {
        ...
        //register (gender, fname, lname, day, month, year, email, company, password, cpassword)
        //await DashPage.register();
        await regPage.regusr("m",helper.test_uname, helper.test_string, "1","January","2020",helper.random_mail("etester","mailinator.com"),helper.test_uname,'a','a')
    ...
    it('Should register a new user', async () => {
        ...
        //register (gender, fname, lname, day, month, year, email, company, password, cpassword)
        //await DashPage.register();
        await regPage.regusr("m",helper.test_uname, helper.test_string, "1","January","2020",helper.random_mail("etester","mailinator.com"),helper.test_uname,"password","password")
        await expect(SecurePage.regsuccess).toBeExisting()
        await expect(SecurePage.regsuccess).toHaveTextContaining('Your registration completed')
