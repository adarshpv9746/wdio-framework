...
import CLInterface from '@wdio/cli/src/interface.js';
import type { RunCommandArguments } from '@wdio/cli/src/types.js';
...
declare class Launcher {
     ...
     */
    exitHandler(callback?: (value: boolean) => void): void | Promise<void>;
    /**
