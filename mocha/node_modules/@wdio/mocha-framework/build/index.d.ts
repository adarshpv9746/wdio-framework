...
import type { MochaOpts as MochaOptsImport, FrameworkMessage, MochaError } from '@wdio/mocha-framework/src/types.js';
...
declare class MochaAdapter {
    ...
    prepareMessage(hookName: keyof Services.HookFunctions): import("@wdio/mocha-framework/src/types.js").FormattedMessage;
...
export * from '@wdio/mocha-framework/src/types.js';
declare global {
