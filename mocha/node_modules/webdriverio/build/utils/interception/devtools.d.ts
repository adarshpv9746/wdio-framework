...
import Interception from 'webdriverio/src/utils/interception/index.js';
import type { Matches, MockOverwrite, MockResponseParams } from 'webdriverio/src/utils/interception/types.js';
type ClientResponse = {
    body: string;
